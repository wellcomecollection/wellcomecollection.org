...
stories
  .add('FeaturedCard', FeaturedCardExample, { info: FeaturedCardReadme })
  .add('DefaultCard', CardExample, { info: CardReadme })
  .add('CompactCard', CompactCardExample, { info: CompactCardReadme });
