...
const FooterExample = () => {
  const hasUpcomingExceptionalOpening = boolean(
    'Has upcoming exceptional opening hours',
    false
  );
  return (
    <Footer
...
stories.add('Footer', FooterExample, { info: Readme });
