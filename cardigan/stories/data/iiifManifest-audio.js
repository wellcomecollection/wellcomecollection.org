const audioManifest = {
  ...
  '@type': 'sc:Manifest',
  label:
    'Florence Nightingale : greetings to the dear old comrades of Balaclava.',
  metadata: [
    {
      label: 'Title',
  ...
  mediaSequences: [
    {
      ...
      elements: [
        {
          '@id':
            'https://dlcs.io/iiif-av/wellcome/1/0128dccf-e2b8-4b0d-b41a-2d9edc6952f5/full/max/default.mp3#identity',
          '@type': 'dctypes:Sound',
          format: 'audio/mp3',
          label:
            'Florence Nightingale : greetings to the dear old comrades of Balaclava.',
          ...
          thumbnail:
            'https://wellcomelibrary.org/posterimages/0056-0000-4402-0102-0-0000-0000-0.jpg',
          rendering: {
            '@id':
              'https://dlcs.io/iiif-av/wellcome/1/0128dccf-e2b8-4b0d-b41a-2d9edc6952f5/full/max/default.mp3',
            format: 'audio/mp3',
          },
        },
      ],
