const videoManifest = {
  ...
  metadata: [
    ...
    },
    {
      label: '',
      value:
        "<a href='https://search.wellcomelibrary.org/iii/encore/record/C__Rb1667616'>View full catalogue record</a>",
    },
    {
  ...
  mediaSequences: [
    {
      ...
      elements: [
        {
          '@id':
            'https://dlcs.io/iiif-av/wellcome/1/97a268c6-a212-4f06-81d3-27628e973bfc/full/full/max/max/0/default.mp4#identity',
          ...
          thumbnail:
            'https://wellcomelibrary.org/posterimages/0055-0000-4078-0000-0-0000-0000-0.jpg',
          rendering: [
            {
              '@id':
                'https://dlcs.io/iiif-av/wellcome/1/97a268c6-a212-4f06-81d3-27628e973bfc/full/full/max/max/0/default.mp4',
              format: 'video/mp4',
            },
            {
              '@id':
                'https://dlcs.io/iiif-av/wellcome/1/97a268c6-a212-4f06-81d3-27628e973bfc/full/full/max/max/0/default.webm',
              format: 'video/webm',
            },
          ],
          height: 0,
