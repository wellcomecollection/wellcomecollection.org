...
<Meta title={`Documentation/Monitoring`} />
...
<h3><abbr title="key result">KR</abbr>s</h3>
...
[Edit this Readme on GitHub](https://github.com/wellcometrust/wellcomecollection.org/main/cardigan/stories/docs/monitoring-strategy.stories.mdx)
