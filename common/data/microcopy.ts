...
export const pageDescriptions = {
  ...
  events: 'Our events take place both online and in our building. Choose from an inspiring range of free talks, discussions and more.',
  ...
  homepage: 'Visit our free museum and library in central London connecting science, medicine, life and art. Explore our exhibitions, live events, gallery tours, restaurant, café, bookshop, and cafe. Fully accessible. Open late on Thursday evenings.',
...
export const homepageHeading = 'A free museum and library exploring health and human experience';

export const newsletterDescription = 'Sign up for news and information from Wellcome Collection';

export const booksPromoOnStoriesPage = 'Get stuck into one of our books, and explore the complexities of the human condition.';
