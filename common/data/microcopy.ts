...
export const requestingDisabled =
  'Requesting is temporarily unavailable while we perform maintenance work, and should be available again next week. In the meantime, email library@wellcomecollection.org the details of your request and when you would like to consult it and we can retrieve the items for you.';
