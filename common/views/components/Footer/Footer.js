...
const Footer = ({navLinks, streetAddress, addressLocality, postalCode, addressCountry, openingHoursId, places, extraClasses, socialItems}: Props) => (
    ...
    <div className="container">
        ...
        <div className={` ${grid({s: 12, m: 6, l: 3})}`}>
          <h3 className={`footer__heading ${font({s: 'HNL5'})}`}>
            ...
            <a href="#" className="footer-nav__brand absolute">
              <FooterWellcomeLogo />
              {% include "icons/wellcome_collection_white.svg.njk" %}
            </a>
          </h3>
      ...
      <div className="grid">
        <div className="grid__cell">
          <h3 className={`${font({s: 'HNL5'})}`}>Connect with us:</h3>
        </div>
      </div>
