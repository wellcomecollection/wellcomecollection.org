  ...
  <table className="opening-hours__table font-HNL5-s">
    <thead className="opening-hours__th font-HNM5-s">
      <tr className="opening-hours__tr">
        <th
          scope="col"
          className="opening-hours__th opening-hours__th--row padding-top-s2 padding-bottom-s2"
        >
        ...
        {venues &&
          venues.map(place => (
            <th
              key={place.name}
              scope="col"
              className="opening-hours__th padding-top-s2 padding-bottom-s2"
            >
              {place.name}
            </th>
          ))}
    ...
    <tbody className="opening-hours__tbody">{dayRows(venues)}</tbody>
  </table>
);
