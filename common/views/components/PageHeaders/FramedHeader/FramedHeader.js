...
const FramedHeader = ({ backgroundTexture, children }: Props) => (
  <div className="framed-header row relative">
    <div
      className="framed-header__image overflow-hidden bg-turquoise"
      style={
        backgroundTexture.image && {
          backgroundImage: `url(${backgroundTexture.image})`,
        }
      }
    >
      <div className="framed-header__wobbly-edge absolute">
        <div
          className="wobbly-edge wobbly-edge--white js-wobbly-edge"
          data-is-valley="true"
    ...
    <div
      className={`relative container container--with-frame bg-white ${spacing(
        { s: 5, m: 7 },
        { padding: ['top'] }
