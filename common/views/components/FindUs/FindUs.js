...
const baseUrl =
  'https://prismic-io.s3.amazonaws.com/wellcomecollection/7a5b0931-e8b0-4568-8f46-9cb3f430bdb9_map.png';
const imageSizes = [563, 425, 282, 600];
const dataSrcset = imageSizes.reduce((acc, size, index) => {
  return `${acc}${index > 0 ? ', ' : ''}${convertImageUri(
    baseUrl,
    size
  )} ${size}w`;
}, '');
  ...
  <div className={`find-us ${font({ s: 'HNL5' })}`}>
      ...
      <div className="find-us__map-container">
        <noscript
          dangerouslySetInnerHTML={{
            __html: `
          <img width='282' height='282' className='image' src=${convertImageUri(
            baseUrl,
            282
          )}
        ...
        />
        <img
          className="find-us__map lazy-image lazyload"
    ...
    <div className="find-us__mapbox">
      <a
        ...
        className="find-us__mapbox-wordmark"
      >
        Mapbox
      </a>
      <div
        className={`find-us__mapbox-attribution-container ${font({
          s: 'HNL7',
        })}`}
      >
        <a
          className="find-us__mapbox-credit-link find-us__mapbox-credit-link--first"
          href="https://www.mapbox.com/map-feedback/"
        >
          © Mapbox |{' '}
        </a>
        <a
          className="find-us__mapbox-credit-link"
