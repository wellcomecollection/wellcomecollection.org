...
import EventDateRange from '@weco/common/views/components/EventDateRange';
import { getLocationText } from '@weco/common/views/components/EventPromo';
import Icon from '@weco/common/views/components/Icon';
import LabelsList from '@weco/common/views/components/LabelsList';
import PrismicImage from '@weco/common/views/components/PrismicImage';
import Space from '@weco/common/views/components/styled/Space';
import TextWithDot from '@weco/common/views/components/TextWithDot';
import WatchLabel from '@weco/common/views/components/WatchLabel';
