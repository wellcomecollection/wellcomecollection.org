...
// This can be overriden to include one or more of `margin-top`, `margin-bottom`, `padding-top`, and `padding-bottom`.
...
const VerticalSpace = styled.div`
  ${props => props.theme.makeSpacePropertyValues(props.size, props.properties)}
`;
