...
import Card from '@weco/common/views/components/Card';
import { Props as ComicPreviousNextProps } from '@weco/common/views/components/ComicPreviousNext';
import FeaturedCard, {
  convertCardToFeaturedCardProps,
  convertItemToFeaturedCardProps,
} from '@weco/common/views/components/FeaturedCard';
