import theme from '@wellcometrust/design-tokens-2025/theme.json';
...
const colors = {
  ...
  yellow: theme.color.yellow['30'],
  lightYellow: theme.color.yellow['20'],

  // Accents
  'accent.purple': theme.color.annotations.purple,
  'accent.lightPurple': theme.color.annotations['purple-light'],
