...
import a11yVisual from './components/A11yVisual';
import addToClipboard from './components/AddToClipboard';
import archive from './components/Archive';
import arrow from './components/Arrow';
import arrowSmall from './components/ArrowSmall';
import article from './components/Article';
import attatch from './components/Attatch';
import audio from './components/Audio';
import audioDescribed from './components/AudioDescribed';
import book from './components/Book';
import bookmark from './components/Bookmark';
import britishSignLanguage from './components/BritishSignLanguage';
import calendar from './components/Calendar';
import calendarAdded from './components/CalendarAdded';
...
import galleryFilled from './components/GalleryFilled';
import gridView from './components/GridView';
import hearingLoop from './components/HearingLoop';
