  ...
  return (
    <svg viewBox="0 0 26 26">
      <path
        ...
        d="M10.17 14.85a1.24 1.24 0 0 1-1.09-.52 2.38 2.38 0 0 1-.37-1.4q0-1.93 1.46-1.93a1.29 1.29 0 0 1 .63.19 1.49 1.49 0 0 1 .57.68l1.46-.76a3 3 0 0 0-2.9-1.55 3.07 3.07 0 0 0-2.28.91 3.35 3.35 0 0 0-.9 2.46 3.36 3.36 0 0 0 .89 2.48 3.17 3.17 0 0 0 2.35.89 3.2 3.2 0 0 0 2.85-1.71l-1.34-.68a1.36 1.36 0 0 1-1.33.94z"
      />
      <path
        className="icon__shape"
      ...
      <path
        className="icon__shape"
        d="M16.43 14.85a1.24 1.24 0 0 1-1.09-.52 2.38 2.38 0 0 1-.37-1.4Q15 11 16.43 11a1.32 1.32 0 0 1 .65.19 1.49 1.49 0 0 1 .57.68l1.44-.76a3 3 0 0 0-2.87-1.57 3.07 3.07 0 0 0-2.28.91 3.35 3.35 0 0 0-.9 2.46 3.38 3.38 0 0 0 .88 2.48 3.17 3.17 0 0 0 2.36.89 3.14 3.14 0 0 0 1.65-.46 3.34 3.34 0 0 0 1.2-1.25l-1.36-.68a1.36 1.36 0 0 1-1.34.96z"
      />
    </svg>
  );
}
...
function ccBy() {
  return (
    <svg viewBox="0 0 26 26">
      <path
        className="icon__shape"
        d="M13 9a1.34 1.34 0 0 0 1.51-1.51A1.35 1.35 0 0 0 13 6a1.35 1.35 0 0 0-1.51 1.53A1.34 1.34 0 0 0 13 9z"
      />
      <path
        className="icon__shape"
        d="M20.74 5.29A10.5 10.5 0 0 0 13 2.14a10.41 10.41 0 0 0-7.63 3.15A10.65 10.65 0 0 0 2.17 13a10.46 10.46 0 0 0 3.2 7.67A10.52 10.52 0 0 0 13 23.88a10.74 10.74 0 0 0 7.78-3.24A10.25 10.25 0 0 0 23.9 13a10.51 10.51 0 0 0-3.16-7.71zm-1.36 14a8.72 8.72 0 0 1-6.33 2.66 8.58 8.58 0 0 1-6.29-2.64A8.54 8.54 0 0 1 4.13 13a8.74 8.74 0 0 1 2.66-6.3 8.46 8.46 0 0 1 6.27-2.6 8.57 8.57 0 0 1 6.29 2.6 8.59 8.59 0 0 1 2.59 6.3 8.28 8.28 0 0 1-2.56 6.24z"
      />
      <path
        className="icon__shape"
        d="M15.27 9.62H10.8a.7.7 0 0 0-.7.7v4.44h1.24V20h3.38v-5.24H16v-4.45a.66.66 0 0 0-.21-.49.68.68 0 0 0-.52-.2z"
      />
    </svg>
  );
}
...
function ccNd() {
  return (
    <svg viewBox="0 0 26 26">
      <path
        className="icon__shape"
        d="M9.2 10.5H17v1.9H9.2zm0 3.5H17v1.9H9.2z"
      />
      <path
        className="icon__shape"
...
function ccZero() {
  return (
    <svg viewBox="0 0 26 26">
      <path
        className="icon__shape"
        d="M13 6.9c-3.6 0-4.4 3.4-4.4 6.2s.9 6.2 4.4 6.2 4.5-3.4 4.5-6.2-.9-6.2-4.5-6.2zm-1.9 6.2c0-1.2.1-3.9 1.9-3.9.1 0 .3 0 .4.1.3.2.4.6.2.9v.1l-2.4 4.4c-.1-.6-.1-1.1-.1-1.6zm1.9 3.8h-.6c-.4-.2-.7-.5-.3-1l2.6-4.6c.1.6.1 1.2.1 1.9.1 1.1 0 3.7-1.8 3.7z"
      />
      <path
        className="icon__shape"
