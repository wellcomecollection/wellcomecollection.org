...
const SvgVolume: FunctionComponent<Props> = props => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...props}>
    <g className="icon__shape" fillRule="nonzero">
      ...
      <path d="M11.49 9.22a1 1 0 1 0-.88 1.78 1.87 1.87 0 0 1 0 3.38A1 1 0 0 0 11 16.3a1 1 0 0 0 .43-.1 3.87 3.87 0 0 0 .06-7v.02zm7.94-3.93a1 1 0 0 0-1.57 1.23 10 10 0 0 1 0 12.37 1 1 0 1 0 1.57 1.24 12 12 0 0 0 0-14.84z" />
    </g>
  </svg>
);
