...
import {
  type SearchParams,
  searchParamsSerialiserForClient,
} from './search-params';
  ...
  return {
    href: {
      ...
      query: removeEmptyProps({
        id,
        ...searchParamsSerialiserForClient(searchParams),
      }),
    },
    as: {
      pathname: `/works/${id}`,
...
export function worksUrl(searchParams: WorksUrlProps): NextLinkType {
  return {
    href: {
      pathname: `/works`,
      query: removeEmptyProps({
        ...searchParamsSerialiserForClient(searchParams, true),
      }),
    },
    as: {
      pathname: `/works`,
    ...
    href: {
      ...
      query: {
        ...
        ...removeEmptyProps({
          ...
          ...searchParamsSerialiserForClient({ ...searchParams, page: 1 }),
        }),
      },
    },
    as: {
