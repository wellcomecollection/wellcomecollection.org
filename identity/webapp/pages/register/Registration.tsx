...
import TextInput from '../../components/Wellcome/TextInput';
import CheckboxRadio from '../../components/Wellcome/CheckBoxLabel';
...
export const Registration: React.FC = () => {
  ...
  useEffect(() => {
    setValid(
      !!(firstName && lastName && email && passwordPolicy.test(pass || ''))
    );
  ...
  const passwordErrorMessage = () => {
    if (commonPassword) {
      return (
        <>
          The password you have entered has been flagged as a common password,
          or you have used your name in the password.
          <br />
