...
export const AccountCreated = (): JSX.Element => {
  return (
    <>
      ...
      <p className="font-hnl font-size-5">
        Please now check your email inbox to verify your email address.
      </p>
      ...
      <p className="font-hnl font-size-5">
        If you don’t see an email from us within the next few minutes, a few
        things could have happened:
      </p>
      <ul>
        <li className="font-hnl font-size-6">
        ...
        <li className="ffont-hnl font-size-6">
