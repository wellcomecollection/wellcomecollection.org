...
aws s3 sync "$ASSETS/humans.txt" s3://i.wellcomecollection.org/humans.txt --dryrun
aws s3 sync "$ASSETS/robots.txt" s3://i.wellcomecollection.org/robots.txt --dryrun
