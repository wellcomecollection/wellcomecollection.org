  ...
  static getInitialProps = async (ctx: Context) => {
    ...
    return {
      ...
      imageUrl:
        ...
        page.promo &&
        page.promo.image &&
        convertImageUri(page.promo.image.contentUrl, 800),
        ...
        >
          ...
          <Fragment>
            ...
            <p>
              We&apos;ll have{' '}
              <a href="#revised">
                revised opening hours over the festive holidays
              </a>
              . If you&apos;re planning to visit a long time in advance, check
              our <a href="#planned">planned closure dates for all of 2019.</a>
            </p>
            ...
            <h2
              ...
              id="planned"
            >
              Planed closure dates and revised hours for 2019
            </h2>
            ...
            <ul>
              <li>
                Library will be closed 6-8 May, 26—28 May and 25—27 August
              </li>
              <li>Everything else will be open with revised hours</li>
            </ul>

            <h3 className="h3">
              Christmas and New Year&apos;s festive holidays
            </h3>
            <ul>
              <li>
                Everything will be closed from 24—26 December and 31 December—1
                January
              </li>
              <li>Library will be closed from 24 December—1 January</li>
              <li>
                Everything else will be closed from 24—26 December and 31
                December—1 January and have revised hours on 27—30 December
              </li>
            </ul>
          </Fragment>
        </ContentPage>
