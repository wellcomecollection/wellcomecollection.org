...
export const topicDescriptions = {
  'Sexual Health':
    'Explore materials relating to sexual health, the body, family planning, safe sex and sex education.',
  Religion:
    'Discover books, artefacts and images which explore the relationship between religion, health and healing through time, from astrology to witchcraft.',
  Anatomy:
    'Explore books, manuscripts, paintings, and illustrations that explore human anatomy, from historical texts to modern illustrations',
  Medicine:
    'Explore the history of medicine, including materials relating to drugs, disease treatments, surgery and other medical practices through time.',
  'Public Health':
    'Our collections are particularly strong in public health materials, including recipe cards, advertisements, public health posters, and history of sanitation systems.',
  'Mental Health':
    'Items tracing the development of our understanding of mental health including personal expressions of mental illness.',
  Genetics:
    "Explore the history of modern genetics through historical books, medical photographs and artist's experiences.",
  Plants:
    'Explore our collections relating to plants and their role in health and healing including botanical paintings and books on medicinal plants.',
};
