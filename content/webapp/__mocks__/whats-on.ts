  ...
  body: [
    {
      ...
      value: {
        text: [
          {
            type: 'paragraph',
            text: 'At every turn the visitor will find something to fascinate.',
            spans: [],
          },
        ],
        citation: [{ type: 'paragraph', text: 'The Times', spans: [] }],
        isPullOrReview: true,
      },
    },
    {
      ...
      value: [
        {
          type: 'paragraph',
          text: 'This permanent gallery explores trust, identity and health in a changing world.',
          spans: [],
        },
      ],
    },
    {
      ...
      value: [
        {
          type: 'paragraph',
          text: 'Being Human explores what it means to be human in the 21st century. It reflects our hopes and fears about new forms of medical knowledge, and our changing relationships with ourselves, each other and the world.',
          spans: [],
        },
        {
          type: 'paragraph',
          text: 'Featuring 50 artworks and objects, the gallery is divided into four sections: Genetics, Minds & Bodies, Infection, and Environmental Breakdown. Discover a refugee astronaut carrying their belongings to an unknown destination, sniff a perfumed bronze sculpture that smells of breast milk, listen to an epidemic jukebox, and watch a fast-food outlet slowly flood.',
          spans: [],
        },
      ],
    },
        ...
        items: [
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/10ee70ce907f1c7668d444d4486f856827a2709d_ep_000832_016.jpg?auto=compress,format',
                  width: 3200,
                  height: 3200,
                  alt: 'Photograph of an exhibition gallery space, with a blue stained wood wall in the background, on which are hung 9 photographs showing flooded landscapes. In the foreground is a life-size artwork of a figure resembling an astronaut. carrying a large net containing assorted objects including a suitcase.',
                  tasl: {
                ...
                '32:15': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/e9d86cdc0e1681168efefae14290008949e0bac0_ep_000832_016.jpg?auto=compress,format',
                  width: 3200,
                  height: 1500,
                  alt: 'Photograph of an exhibition gallery space, with a blue stained wood wall in the background, on which are hung 9 photographs showing flooded landscapes. In the foreground is a life-size artwork of a figure resembling an astronaut. carrying a large net containing assorted objects including a suitcase.',
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'Yinka Shonibare’s ‘Refugee Astronaut’ encourages us to ask questions: who are they?  Why have they had to leave earth in such a hurry?  If you look closely at the possessions on their back you can find books, photographs and intriguing objects: a telescope, a camera, even a frying pan.',
                spans: [
                  {
                    start: 0,
                    end: 15,
          ...
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                '16:9': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/b6eeb509-8569-44e3-9d8e-e19790580846_EP_001057_045_Full.jpg?auto=compress,format&rect=0,210,4000,2250&w=3200&h=1800',
                  width: 3200,
                  height: 1800,
                  alt: 'Photograph of an exhibit in a gallery space of an artwork which resembles a juke box.',
                  tasl: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/b6eeb509-8569-44e3-9d8e-e19790580846_EP_001057_045_Full.jpg?auto=compress,format&rect=665,0,2670,2670&w=3200&h=3200',
                  width: 3200,
                  height: 3200,
                  alt: 'Photograph of an exhibit in a gallery space of an artwork which resembles a juke box.',
                  tasl: {
            ...
            caption: [
              {
                ...
                spans: [
                  ...
                  },
                  {
                    ...
                    data: {
                      link_type: 'Web',
                      url: 'http://www.bethanlaurawood.com/',
                    },
                  },
                ],
              },
          ...
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                '16:9': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/9138e01d1adafd60f760ffc3d350001516273207_ep_000832_022.jpg?auto=compress,format',
                  width: 3200,
                  height: 1800,
                  alt: "Photograph of a artwork banner hung in a gallery setting on a stained wood wall. On the banner is written the words 'water is life'. Below the words is an illustrated human figure in black and white, set in the context of land, sky and weather.",
                  tasl: {
                ...
                '32:15': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/adb39a4512ef73e922fbae2d1c6f83babcd34eda_ep_000832_022.jpg?auto=compress,format',
                  width: 3200,
                  height: 1500,
                  alt: "Photograph of a artwork banner hung in a gallery setting on a stained wood wall. On the banner is written the words 'water is life'. Below the words is an illustrated human figure in black and white, set in the context of land, sky and weather.",
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'Artist Isaac Murdoch designed and carried this banner at the Standing Rock Protest against the Dakota Access Pipeline. Murdoch is a member of Onaman Collective, a group of indigenous artists and environmentalists and has shared the banner designs for other people to use in similar protests.',
                spans: [
                  {
                    start: 221,
                    end: 246,
                    ...
                    data: {
                      link_type: 'Web',
                      url: 'http://onamancollective.com/murdoch-belcourt-banner-downloads/',
                    },
                  },
                ],
              },
          ...
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                '16:9': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/b1a4406a9e9f1649e1831f2f50a39c0b76b6d424_ep_000832_030.jpg?auto=compress,format',
                  width: 3200,
                  height: 1800,
                  alt: 'Photograph of an exhibition display case containing ceramic artworks which resemble pots or vases, coloured in light pinks and yellows. The surface of the objects are sometimes cracked, sometimes textured.',
                  tasl: {
                ...
                '32:15': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/e3012c08b6138be831f846ebaae8130320a01ecf_ep_000832_030.jpg?auto=compress,format',
                  width: 3200,
                  height: 1500,
                  alt: 'Photograph of an exhibition display case containing ceramic artworks which resemble pots or vases, coloured in light pinks and yellows. The surface of the objects are sometimes cracked, sometimes textured.',
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'Just as you might inherit a precious family vase, you might also inherit the family tendency to acne or osteoporosis. Artist Tamsin Van Essen created these ‘Medical Heirlooms’ as a tribute to our medical heritage. Each is unique and each is beautiful.',
                spans: [
                  {
                    start: 125,
                    end: 141,
                    ...
                    data: {
                      link_type: 'Web',
                      url: 'http://www.tamsinvanessen.com/',
                    },
                  },
                ],
              },
          ...
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                '16:9': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/9901862d-680e-4a10-82cf-f2d328d628c9_SDP_20201005_0278-124-Edit.jpg?auto=compress,format&rect=0,384,2000,1125&w=3200&h=1800',
                  width: 3200,
                  height: 1800,
                  alt: 'A photograph showing a visitor looking at an exhibition exhibit of a mannequin wearing a white hazmat suit, visor and green apron standing on a low wooden platform. On the green apron there is a portrait of the carer that would have been wearing the suit whilst treating Ebola patients. To the right is the back of another visitor who is looking at a different exhibit.',
                  tasl: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/9901862d-680e-4a10-82cf-f2d328d628c9_SDP_20201005_0278-124-Edit.jpg?auto=compress,format&rect=54,0,1892,1892&w=3200&h=3200',
                  width: 3200,
                  height: 3200,
                  alt: 'A photograph showing a visitor looking at an exhibition exhibit of a mannequin wearing a white hazmat suit, visor and green apron standing on a low wooden platform. On the green apron there is a portrait of the carer that would have been wearing the suit whilst treating Ebola patients. To the right is the back of another visitor who is looking at a different exhibit.',
                  tasl: {
                ...
                spans: [
                  {
                    ...
                    data: {
                      link_type: 'Web',
                      url: 'http://www.marybethheffernan.com/',
                    },
                  },
                ],
              },
          ...
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/54b2b1fd9b435b7629ee33aed0c28d25b41342a1_ep000832_0073.jpg?auto=compress,format',
                  width: 3200,
                  height: 3200,
                  alt: 'Photograph of a gallery wall showing a framed photograph of a woman in bright red dress in a medical clinic.',
                  tasl: {
                ...
                '32:15': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/251895750dd7a2620a7def9eb6bc3edfd7ed1af7_ep000832_0073.jpg?auto=compress,format',
                  width: 3200,
                  height: 1500,
                  alt: 'Photograph of a gallery wall showing a framed photograph of a woman in bright red dress in a medical clinic.',
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'Artist Kia LaBeija was born HIV-positive and was told she wouldn’t live long enough to go to prom. Here, in photograph ‘Eleven’, her red prom dress expresses her defiant survival.',
                spans: [
                  {
                    start: 7,
                    end: 18,
                    ...
                    data: {
                      link_type: 'Web',
                      url: 'http://www.kialabeijastudio.com/',
                    },
                  },
                ],
              },
          ...
          },
          {
            ...
            image: {
              ...
              width: 4000,
              height: 2667,
              alt: "Photograph of an exhibition gallery space and a display surface on which is an artwork made of metal, in an organic shape. In front of the artwork is a raised captions panel in text and braille and a large sign with the words 'Please do not touch'.",
              tasl: {
                title:
              ...
              richCrops: {
                ...
                '16:9': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/18dc041d-d885-4450-8446-596ba4b5b58a__J5A0489.jpg?auto=compress,format&rect=0,209,4000,2250&w=3200&h=1800',
                  width: 3200,
                  height: 1800,
                  alt: "Photograph of an exhibition gallery space and a display surface on which is an artwork made of metal, in an organic shape. In front of the artwork is a raised captions panel in text and braille and a large sign with the words 'Please do not touch'.",
                  tasl: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/18dc041d-d885-4450-8446-596ba4b5b58a__J5A0489.jpg?auto=compress,format&rect=667,0,2667,2667&w=3200&h=3200',
                  width: 3200,
                  height: 3200,
                  alt: "Photograph of an exhibition gallery space and a display surface on which is an artwork made of metal, in an organic shape. In front of the artwork is a raised captions panel in text and braille and a large sign with the words 'Please do not touch'.",
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'This sculpture holds a secret – lean in and sniff and you will smell breast milk. Designed by Tasha Marks of AVM Curiosities, ‘5318008’ is a playful tribute to our intimate relationship with bacteria. The title is a joke – turn the numbers upside down to read ‘BOOBIES’.',
                spans: [
                  {
                    start: 109,
                    end: 124,
                    ...
                    data: {
                      link_type: 'Web',
                      url: 'https://www.avmcuriosities.com/',
                    },
                  },
                ],
              },
          ...
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                '32:15': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/735735e0e977b472cb7d7c65c156aeba7b89f556_ep000832_0076.jpg?auto=compress,format',
                  width: 3200,
                  height: 1500,
                  alt: "Photograph of an artwork on a display plinth in a gallery space. The artwork consists of 2 gas canisters and a pressure cooker, each one has a map of the earth's landmasses carved out of its casing.",
                  tasl: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/1461bb3b4bec2cd01ca6eb75f6916f02c34df239_ep000832_0076.jpg?auto=compress,format',
                  width: 3200,
                  height: 3200,
                  alt: "Photograph of an artwork on a display plinth in a gallery space. The artwork consists of 2 gas canisters and a pressure cooker, each one has a map of the earth's landmasses carved out of its casing.",
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'Carving a map into these pressurised containers reduces the danger of an explosion but reminds us of global threats such as environmental breakdown. Titled ‘The World Under Pressure’, Batoul S’Himi’s domestic objects encourage us to think about our impact on the world.',
                spans: [],
              },
            ],
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                '16:9': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/e0d08a48a855f9697e7cd9d887702e49c58a767a_ep_000832_033.jpg?auto=compress,format',
                  width: 3200,
                  height: 1800,
                  alt: "Photograph of an exhibition display case, which contains a red collection box bearing a sticker which says, 'Help the normals'. Next to the collection box on one side is part of a comic strip and on the other side are 2 pill boxes with the words 'Dignity' and other smaller text printed on the packaging.",
                  tasl: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/39d06c5031ee9fa612a7c215692edd389aa0bea9_ep_000832_033.jpg?auto=compress,format',
                  width: 3200,
                  height: 3200,
                  alt: "Photograph of an exhibition display case, which contains a red collection box bearing a sticker which says, 'Help the normals'. Next to the collection box on one side is part of a comic strip and on the other side are 2 pill boxes with the words 'Dignity' and other smaller text printed on the packaging.",
                  tasl: {
          ...
          },
          {
            ...
            image: {
              ...
              width: 4000,
              height: 2669,
              alt: 'Photograph of a galley wall made of green stained wood, at an angle. On the wall are 3 artworks receding into the distance. The artwork closest to the camera shows a full length photograph of a naked woman which has been illustrated over the surface with colourful drawings.',
              tasl: {
                title:
              ...
              richCrops: {
                ...
                '32:15': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/6d47bb27f57c58a5443f91e1f776f58d14309fed_ep_000832_007.jpg?auto=compress,format',
                  width: 3200,
                  height: 1500,
                  alt: 'Photograph of a galley wall made of green stained wood, at an angle. On the wall are 3 artworks receding into the distance. The artwork closest to the camera shows a full length photograph of a naked woman which has been illustrated over the surface with colourful drawings.',
                  tasl: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/41d89b41fb70a263f9db81161be49ae35f2f1adf_ep_000832_007.jpg?auto=compress,format',
                  width: 3200,
                  height: 3200,
                  alt: 'Photograph of a galley wall made of green stained wood, at an angle. On the wall are 3 artworks receding into the distance. The artwork closest to the camera shows a full length photograph of a naked woman which has been illustrated over the surface with colourful drawings.',
                  tasl: {
          ...
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/151c3a0c7ae82f186f46f694046e8306e6d5c6af_ep_000832_038.jpg?auto=compress,format',
                  width: 3200,
                  height: 3200,
                  alt: 'Photograph of the contents of an exhibition display case. The objects on display include a scientific pipet, petri dishes, latex gloves, specimen tubes and a jar.',
                  tasl: {
                ...
                '32:15': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/755ad93492b89368d553e7bbaad039c46bb39583_ep_000832_038.jpg?auto=compress,format',
                  width: 3200,
                  height: 1500,
                  alt: 'Photograph of the contents of an exhibition display case. The objects on display include a scientific pipet, petri dishes, latex gloves, specimen tubes and a jar.',
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'Don’t try this at home! This kit claims to include everything you would need to edit DNA.  ',
                spans: [],
              },
            ],
          },
          {
            ...
            image: {
              ...
              richCrops: {
                ...
                '16:9': {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/09b89fe1bcd0a3a3091bcda6b5f62e5e53d572ca_ep_000832_027.jpg?auto=compress,format',
                  width: 3200,
                  height: 1800,
                  alt: 'Photograph of a gallery installation showing a bench with yellow cushions facing a large video projection. The projection shows the inside of a McDonalds restaurant looking down from a high viewpoint in which the restaurant floor is beginning to flood with water.',
                  tasl: {
                ...
                square: {
                  contentUrl:
                    'https://images.prismic.io/wellcomecollection/9ed554ac496cb5238a50674c840b40df4fc43acd_ep_000832_027.jpg?auto=compress,format',
                  width: 3200,
                  height: 3200,
                  alt: 'Photograph of a gallery installation showing a bench with yellow cushions facing a large video projection. The projection shows the inside of a McDonalds restaurant looking down from a high viewpoint in which the restaurant floor is beginning to flood with water.',
                  tasl: {
            ...
            caption: [
              {
                type: 'paragraph',
                text: 'Watch as water slowly fills the screen in this vast video projection of ‘Flooded McDonald’s’. Artists Superflex built a scale model of McDonald’s to destroy for the film, even down to an ‘employee of the month’ award on the wall.  Like environmental breakdown itself, it starts slowly but builds until soon, everything is under water.',
                spans: [
                  {
                    start: 102,
                    end: 111,
    ...
    },
    {
      ...
      weight: 'default',
      value: [
        { type: 'heading2', text: 'Audio Description', spans: [] },
        {
          type: 'paragraph',
          text: 'We have recorded audio descriptions of every exhibit, plus a highlights tour of 11 stops with optional directions in between. These audio tracks are available on the VocalEyes website.',
          spans: [
            {
              start: 149,
              end: 183,
              ...
              data: {
                link_type: 'Web',
                url: 'https://vocaleyes.co.uk/being-human-at-wellcome-collection-recorded-audio-description',
              },
            },
          ],
        },
