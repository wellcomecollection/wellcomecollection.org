...
module "catalogue" {
  ...
  listener_https_arn                 = local.old_alb_listener_https_arn
  listener_http_arn                  = local.old_alb_listener_http_arn
...
module "subdomain_listener" {
  ...
  alb_listener_https_arn = local.old_alb_listener_https_arn
  alb_listener_http_arn  = local.old_alb_listener_http_arn
