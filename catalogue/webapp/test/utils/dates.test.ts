...
describe('findNextPickUpDay: finds the earliest date on which the venue is normally open', () => {
  ...
  it('returns the date of the next regular pick-up day, if the date provided is a regular closed day', () => {
    const result = findNextPickUpDay(
...
describe('determineNextAvailableDate', () => {
  ...
  it('returns the following Tuesday rather than a Sunday/Monday, if the Sunday is the only closed day', () => {
