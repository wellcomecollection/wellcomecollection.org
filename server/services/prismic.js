...
export async function getArticle(id: string, previewReq: ?Request, renderType) {
  ...
  switch (article.type) {
    case 'articles': return article.data.displayType.slug === 'basic-page' && Object.assign({}, parseBasicPageDoc(article), {displayType: 'basic'}) || Object.assign({}, parseArticleDoc(article), {displayType: 'article'});
